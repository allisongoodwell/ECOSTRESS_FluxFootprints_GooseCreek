...
## 1. Request Parameters  
    ...
    Date Completed: 2023-07-20T14:20:24.802094  

    ID: 7534b975-8550-4531-8530-6aeb303652b4  
    ...
    Details:  
        ...
        Layers:  
                ...
                EVAPOTRANSPIRATION_ALEXI_ETdaily (ECO3ETALEXI.001)  
                EVAPOTRANSPIRATION_PT_JPL_ETinst (ECO3ETPTJPL.001)  
                EVAPOTRANSPIRATION_PT_JPL_ETdaily (ECO3ETPTJPL.001)  
      
        Output Projection:            Native Projection
        Output Format:                geotiff  

    Version: This request was processed by AppEEARS version 3.32  

## 2. Request File Listing  

**Supporting Files:**  

- USRB2019-ECO3ETALEXI-001-metadata.xml
- USRB2019-ECO3ETPTJPL-001-metadata.xml
- USRB2019-granule-list.txt
- USRB2019-request.json
- ECO3ETALEXI-001-EVAPOTRANSPIRATION-ALEXI-QualityFlag-lookup.csv
- ECO3ETALEXI-001-EVAPOTRANSPIRATION-ALEXI-QualityFlag-Statistics-QA.csv
- ECO3ETPTJPL-001-EVAPOTRANSPIRATION-PT-JPL-ETinstUncertainty-Statistics-QA.csv
- ECO3ETALEXI-001-Statistics.csv
- ECO3ETPTJPL-001-Statistics.csv

**Data Files:**  

Number of Extracted Data Files: 324  
Total Size of Extracted Data Files: 305.36 MB  
...
- Hook, S., Cawse-Nicholson, K. (2021). ECOSTRESS Evapotranspiration dis-ALEXI Daily L3 CONUS 70 m V001. NASA EOSDIS Land Processes Distributed Active Archive Center. Accessed 2023-07-20 from https://doi.org/10.5067/ECOSTRESS/ECO3ETALEXI.001. Accessed July 20, 2023.
- Hook, S., Fisher, J. (2019). ECOSTRESS Evapotranspiration PT-JPL Daily L3 Global 70 m V001. NASA EOSDIS Land Processes Distributed Active Archive Center. Accessed 2023-07-20 from https://doi.org/10.5067/ECOSTRESS/ECO3ETPTJPL.001. Accessed July 20, 2023.

## 10. Software Citation  

AppEEARS Team. (2023). Application for Extracting and Exploring Analysis Ready Samples (AppEEARS). Ver. 3.32. NASA EOSDIS Land Processes Distributed Active Archive Center (LP DAAC), USGS/Earth Resources Observation and Science (EROS) Center, Sioux Falls, South Dakota, USA. Accessed July 20, 2023. https://appeears.earthdatacloud.nasa.gov
